      ...
      <SheetBody className="min-w-0 space-y-6 !px-3 !py-4 sm:!px-4 md:!px-5 md:!py-5">
        {visibleSections.length === 0 ? (
          ...
          <div className="flex min-w-0 flex-col gap-6 xl:flex-row xl:items-start">
            <aside className="timiq-help-print-toc xl:w-56 xl:shrink-0 xl:sticky xl:top-2 xl:self-start xl:max-h-[calc(var(--layout-desktop-content-height)-3rem)] xl:overflow-y-auto xl:border-r xl:border-[var(--color-border)] xl:pr-4">
