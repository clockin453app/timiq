...
function hasVisibleTimesheetWeekActivity(row: TimesheetWeekSummaryRow): boolean {
  return (
    row.clocked_seconds > 0 ||
    row.payable_seconds > 0 ||
    row.payroll_seconds > 0 ||
      ...
      <SheetBody className="min-w-0 space-y-3 md:p-5">
        ...
        {employeeListMode ? (
          <div className="hidden overflow-hidden rounded-[22px] border border-[#dbe3ee] bg-white shadow-[0_18px_45px_rgba(15,23,42,0.06)] md:block">
            ...
            <div className="w-full min-w-0 max-w-full overflow-x-auto px-4 pb-4">
        ...
        {!loading && companySheet && viewingAllEmployees && companySheet.completed_shift_count > 0 ? (
          <div className="timiq-scroll-x w-full min-w-0 max-w-full">
