...
import { fetchNotificationSummary, type NotificationSummary } from "../../features/notifications/api";
    ...
    <div className="relative shrink-0">
      ...
      {open ? (
        <>
          ...
          />
          <div className="absolute right-0 z-[35] mt-1 w-[min(100vw-1rem,22rem)] max-w-[calc(100vw-1rem)] rounded-[var(--radius-md)] border border-[var(--color-border-dark)] bg-[var(--color-sheet)] shadow-[0_4px_16px_rgba(15,23,42,0.12)]">
            ...
            <div className="max-h-[min(70dvh,24rem)] overflow-y-auto py-1">
              {err ? (
                ...
                <ul className="min-w-0">
                  {data.items.map((it) => (
                    <li key={it.kind} className="border-b border-[var(--color-border)] last:border-b-0">
                      <Link
