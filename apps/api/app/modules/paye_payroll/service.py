...
def _employee_item_response(
    ...
    return MonthlyPayeItemResponse(
        ...
        gross_hourly_pay=item.gross_hourly_pay,
        ...
        overtime_policy_snapshot=item.overtime_policy_snapshot,
        time_record_source_snapshot=item.time_record_source_snapshot,
