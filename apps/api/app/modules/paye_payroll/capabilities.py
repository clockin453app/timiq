...
PAYE_CAPABILITIES: tuple[PayeCapability, ...] = (
    ...
    _coming_soon("pay_type.hourly", "Hourly PAYE", "pay_types", "PAYE-specific hourly pay, not CIS hourly rate."),
    _coming_soon("pay_type.overtime", "PAYE overtime", "pay_types", "PAYE-specific overtime rules."),
    _coming_soon("pay_type.bonus", "Bonus pay", "pay_types", "Taxable bonus pay component."),
    _coming_soon("pay_type.commission", "Commission pay", "pay_types", "Taxable commission pay component."),
