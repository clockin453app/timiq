...
PAYE_CAPABILITIES: tuple[PayeCapability, ...] = (
    ...
    _coming_soon("pay_type.hourly", "Hourly PAYE", "pay_types", "Settings foundation is stored; hourly PAYE calculation is not enabled yet."),
    _coming_soon("pay_type.overtime", "PAYE overtime", "pay_types", "Settings foundation is stored; PAYE overtime calculation is not enabled yet."),
